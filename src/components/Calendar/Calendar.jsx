...
const Calendar = () => {
  ...
  return (
    <div className="flex flex-col  w-full">
      <div className="flex justify-between m-4 max-md:flex-col">
        <h1 className="font-bold text-lg">Calender</h1>
        <div className=" space-x-3 ">
          <button
            className="bg-gray-200 hover:bg-indigo-600 rounded-lg px-4 py-1 "
            onClick={() => {
              navigate("/Calendar");
            }}
          >
          ...
          <button className="bg-gray-200 hover:bg-indigo-600 rounded-lg px-4 py-1 ">
            Week
          </button>
          <button
            className="bg-gray-200 hover:bg-indigo-600 rounded-lg px-4 py-1 "
      ...
      <div className="flex flex-row justify-between  p-2">
        <button
          ...
          className="bg-blue-500 ml-16 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded"
        >
          + Create Schedule
        </button>
      </div>
