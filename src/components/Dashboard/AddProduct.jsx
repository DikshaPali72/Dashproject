...
const AddProduct = () => {
  ...
  return (
    <div className="  flex w-full h-fit justify-between  flex-col">
      <div className="flex  h-fit justify-between p-3  w-56 ">
      ...
      <div className="flex items-center gap-2 rounded-md justify-between w-56 ">
        <div className=" flex justify-around w-56 ">
          <button className="px-4 py-2 rounded-md  hover:bg-indigo-600 bg-blue-600">
            product
          </button>
          <button className="px-4 py-2 rounded-md hover:bg-indigo-600 bg-blue-600 ">
            customer
      ...
      <div className="  flex justify-evenly mt-5  ">
        <div className="flex flex-wrap  ">
          <div className=" rounded-lg shadow w-full  flex justify-evenly ">
            ...
            <div className="rounded-lg shadow p-6 flex  ">
              ...
              <p className="text-sm ml-10 items-center">
                +1000 Sales Today
              </p>
            </div>
          </div>
        ...
        <div className="mt-[-100px]">
          <div className=" max-w-md p-2 space-y-6  rounded shadow-md ">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="mb-4">
                ...
                <p className="text-sm text-stone-400">
                  This the New creation Of apple This the New creation Of apple
                  This the New creation Of apple This the New creation Of apple.
                </p>
              </div>
